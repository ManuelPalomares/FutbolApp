Ext.define('EscuelaFutbol.view.BannerPrincipal', {
    ...
    items: [{
            ...
            html: "<img  alt='logo' width='35%' height='65%' src='resources/img/logoChampions.jpg'></img><div class='x_tituloApp'>Sistema de Gestión Deportiva Escuela de Futbol Champions</div>"
        }, {
            xtype: "container",
            width: "30%",
            cls: "x_panelSession",
            ...
            items: [{
                    ...
                    items: [
                        ...
                        {xtype: "label", id: "x_labelNombreUsuario", text: ""}]
                }, {
                    xtype: "button",
